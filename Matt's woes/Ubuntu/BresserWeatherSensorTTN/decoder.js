var bytes= Buffer.from('05 35 05 38 43 01 F4 58 00 00 00 00 70 08 00 80 63 44 1C 01 1C 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00')
...
return decode(
      bytes,
      [uint8, bitmap,        temperature,     uint8,       uint16fp1,             uint16fp1,            uint16fp1,
       rawfloat,  rawfloat,    rawfloat,              rawfloat,             rawfloat
      ],
      ['sensorID',   'status',      'air_temp_c',    'humidity',  'wind_gust_meter_sec', 'wind_avg_meter_sec', 'wind_direction_deg',
       'rain_mm', 'rain_hr',   'rain_day',            'rain_week',          'rain_mon'
      ]
    );
}
